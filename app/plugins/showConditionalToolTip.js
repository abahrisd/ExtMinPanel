 ...
 *
 * Extjs plugin that adds tooltips only when text overflows the grid cell.
 */
Ext.define('ExtMinPanel.plugins.showConditionalToolTip', {
                ...
                if (column.hasCustomRenderer == true){
                    ...
                    column.renderer = Ext.Function.createSequence(column.renderer,function(a,b,c,d,e,f,g){
                        ...
                        if(a){
                            ...
                            if ((g.ownerCt.columns[e] && (g.ownerCt.columns[e].getEl().getWidth() || 10) <= (((tm.getSize(a).width + 15) || 0))) ||
                                (g.ownerCt.columns[0].getEl().getWidth() || 10) <= (((tm.getSize(a).width + 15) || 0))){
                    ...
                    if (!column.isXType('datecolumn') &&
                        !column.isXType('checkcolumn') &&
                        !column.isXType('actioncolumn') &&
                        !column.isXType('numbercolumn')) {
                        ...
                        column.renderer = function (a, b, c, d, e, f, g) {
                            if (a) {
                                if ((g.ownerCt.columns[e] && (g.ownerCt.columns[e].getEl().getWidth() || 10) <= (((tm.getSize(a).width + 15) || 0))) || (g.ownerCt.columns[0].getEl().getWidth() || 10) <= (((tm.getSize(a).width + 15) || 0))) {
                                    b.tdAttr += 'data-qtip="' + a + '"';
                                }
                                return a;
                            }
